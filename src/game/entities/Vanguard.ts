...
export const GunTextures = new Map<GunType, [string, string | null]>([
    [GunType.MACHINE_GUN, ["vanguard_m", "bullet"]],
    [GunType.ROCKET_LAUNCHER, ["vanguard_r", "rocket"]],
    [GunType.LASER, ["vanguard_l", null]],
]);
